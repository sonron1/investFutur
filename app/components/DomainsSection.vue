<template>
  <section id="domaines" class="py-20 bg-slate-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <!-- En-tête -->
      <div class="text-center mb-12" data-aos="fade-up">
        <div class="text-blue-600 text-sm font-semibold uppercase tracking-wider mb-3">Opportunités</div>
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 gap-5 mb-12" data-aos="fade-up" data-aos-delay="200">
        <div class="text-center bg-white rounded-2xl border border-slate-100 shadow-sm p-5">
      ...
      <div v-if="filteredSectors.length === 0" class="text-center py-12" data-aos="fade-up">
        ...
        <button @click="resetFilters" class="btn-primary inline-flex items-center">
          ...
          <div class="relative h-44 overflow-hidden">
            ...
            <div class="absolute top-3 left-3">
              <div class="w-9 h-9 bg-white/95 backdrop-blur-sm rounded-lg flex items-center justify-center shadow-sm">
                <i :class="`${sector.icon} text-blue-600`"></i>
              </div>
            </div>
      ...
      <!-- Call to Action -->
      <div class="mt-14 text-center" data-aos="zoom-in">
