    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="bg-white rounded-2xl p-8 border border-slate-100 shadow-sm mb-12" data-reveal>
        <div class="text-center mb-8">
          <div class="section-tag justify-center">Avantages</div>
      ...
      <div class="text-center mb-14" data-reveal data-reveal-delay="200">
        <div class="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl p-8 md:p-10 text-white relative overflow-hidden">
          ...
          <div class="relative z-10">
            ...
            <div class="inline-flex items-center gap-3 bg-white/10 backdrop-blur-sm rounded-xl px-5 py-3">
      ...
      <div class="pt-12 border-t border-slate-200">
        <div class="text-center mb-10" data-reveal>
          <div class="section-tag justify-center">Confiance</div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6" data-reveal data-reveal-delay="200">
          <div v-for="stat in trustStats" :key="stat.label" class="text-center group">
...
const processAdvantages = [
  { icon: 'fas fa-bolt', title: 'Ultra rapide', description: 'Investissement en moins de 5 minutes' },
  { icon: 'fas fa-shield-alt', title: '100% sécurisé', description: 'Cryptage bancaire et fonds protégés' },
  { icon: 'fas fa-brain', title: 'IA intégrée', description: 'Recommandations personnalisées par IA' },
  { icon: 'fas fa-headset', title: 'Support expert', description: 'Conseillers disponibles 7j/7' }
]

const trustStats = [
  { label: 'Investisseurs actifs', numericValue: '2 500', suffix: '+', colorClass: 'text-blue-600' },
  { label: 'Projets financés', numericValue: '156', suffix: '', colorClass: 'text-emerald-600' },
  { label: 'Taux de satisfaction', numericValue: '98', suffix: '%', colorClass: 'text-indigo-600' },
  { label: 'Capital investi', numericValue: '189', suffix: 'M€', colorClass: 'text-amber-600' }
]
